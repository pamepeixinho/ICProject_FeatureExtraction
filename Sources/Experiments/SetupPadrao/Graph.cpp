...
void Graph::printVerticesY(const char *arquivo_vertices){
...
void Graph::printVerticesD(const char *arquivo_vertices){
	strcpy(v, arquivo_vertices);
	strcpy(aux, arquivo_vertices);
...
void Graph::printGraphB(const char *arquivo_grafo){
...
void Graph::printGraph(const char *arquivo_grafo){
	char L = 'L';
	char H = 'H';
...
void Graph::ConstructEdges(Label l, Hsv_Dist h){
...
void Graph::ConstructEdges(Label l, Hsv_DiscrY h){
